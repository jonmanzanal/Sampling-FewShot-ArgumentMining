...
"""
for i in range(4):
    input_dir = '/home/jon/Documentos/TFM/ecai2020-transformer_based_am-master/data/neoplasm/jsonf/50shot/%s.json'%(i+1)
    output = '/home/jon/Documentos/TFM/ecai2020-transformer_based_am-master/data/neoplasm/tsvf/50shot/%s.tsv'%(i+1)
    read_ssv(input_dir, output)
"""

input_dir = '/home/jon/Documentos/TFM/EntLM-main/dataset/mine/lower/train.json'
output = '/home/jon/Documentos/TFM/EntLM-main/dataset/mine/distant_data/lower/train.txt'
read_ssv(input_dir, output,por=1)
